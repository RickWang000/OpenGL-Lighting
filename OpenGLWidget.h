...
private:
    ...
    QVector<QVector3D> modelsColor;
    QVector<float> modelsShininess;
    QVector<float> modelsOpacity;

    QVector<QVector3D> modelsKa;
    QVector<QVector3D> modelsKd;
    QVector<QVector3D> modelsKs;
    QVector<QVector3D> modelsF0;
    QVector<float> modelsIor;
    QVector<int> modelsType;
    ...
    QOpenGLShaderProgram rayTracingShaderProgram;
